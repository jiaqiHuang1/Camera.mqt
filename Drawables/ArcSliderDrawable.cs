...
{
    public class ArcSliderDrawable : IDrawable
    {
        private readonly ArcSliderViewModel _viewModel;
        ...
        public ArcSliderDrawable(ArcSliderViewModel viewModel)
        {
        ...
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            canvas.DrawArc(arcLeft, arcTop, _outerRadius * 2, _outerRadius * 2, 0, 180, false, false);
            ...
            float boxSize = 50;
            float boxLeft = _centerX - boxSize / 2;
            float boxTop = _centerY - 50;
            ...
            canvas.FontSize = 20;
            canvas.DrawString($"{_viewModel.Angle:0}°",
